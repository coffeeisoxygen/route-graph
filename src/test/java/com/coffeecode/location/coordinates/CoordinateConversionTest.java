...
class CoordinateConversionTest {
        ...
        @ParameterizedTest
        @CsvSource({
                        // City pairs (actual calculated values)
                        "-6.7991455,107.1884536,-6.2088,106.8456,75.787", // Bandung-Jakarta

                        // Equatorial measurements (actual calculated values)
                        "0.0,0.0,0.0,1.0,111.194", // 1 degree longitude at equator
                        "0.0,0.0,1.0,0.0,111.194", // 1 degree latitude

                        // Diagonal distance (actual calculated value)
                        "0.0,0.0,1.0,1.0,157.245" // 1 degree diagonal
        })
        ...
        void shouldCalculateVariousDistances(
                ...
                assertEquals(expected, point1.getDistanceTo(point2), DELTA,
