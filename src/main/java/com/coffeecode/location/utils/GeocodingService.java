...
public class GeocodingService {
    ...
    public static String getLocationName(double latitude, double longitude) throws GeoserviceException {
        // Endpoint untuk Nominatim API
        String url = "https://nominatim.openstreetmap.org/reverse?lat=" + latitude + "&lon=" + longitude
