...
// private static final String PROPERTIES_NULL = "Pipe properties cannot be
// null";
// private static final String INVALID_DIAMETER = "Pipe diameter must be
// positive";
// private static final String INVALID_LENGTH = "Pipe length must be positive";
// private static final String INVALID_NODES = "Pipe must have source and
// destination";
// private static final String NEGATIVE_PRESSURE = "Pressure cannot be
// negative";
