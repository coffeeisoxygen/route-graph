...
// static void validatePipeProperties(PipeMaterial type, double diameter, double
// roughness) {
...
// static void validatePipeConstruction(NetworkNode source, NetworkNode
// destination, PipeProperties properties) {
...
// validatePipeProperties(properties.getType(), properties.getDiameter(),
// properties.getRoughness());
// }
// }
