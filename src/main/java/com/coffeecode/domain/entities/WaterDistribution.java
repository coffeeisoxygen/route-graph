...
// * with pipes. It also maintains a list of customers and logs actions
// performed
// * on the network.</p>
// *
// * <p>
...
// public synchronized Optional<Pipe> connectNodes(NetworkNode from, NetworkNode
// to, PipeProperties properties) {
// try {
