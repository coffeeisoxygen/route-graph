...
// double reynoldsNumber = velocityCalculator.calculateWithReynolds(velocity,
// diameter);
// double frictionFactor =
// headLossCalculator.calculateFrictionFactor(reynoldsNumber, diameter,
// roughness);
// double headLoss = headLossCalculator.calculate(length, diameter,
// frictionFactor, velocity);
...
// log.debug("Using default velocity: {} m/s for pipe diameter: {} m", velocity,
// diameter);
